...
配套 Demo：[`webgpu-shader-demo/skinning/`](../../webgpu-shader-demo/skinning/) — 双骨骼手臂，`sin(time)` 驱动肘关节。
...
Demo 手臂 mesh 在 [`skinning/utils/gpu.js`](../../webgpu-shader-demo/skinning/utils/gpu.js) 里预置权重。
