...
配套 Demo：[`webgpu-shader-demo/wgsl/`](../../webgpu-shader-demo/wgsl/)（`1` 渐变 / `2` 噪声 / `3` 同心环）。
...
Demo [`wgsl/shaders/main.wgsl`](../../webgpu-shader-demo/wgsl/shaders/main.wgsl) 含 `hash` 噪声与 `length` 画环，可直接改数实验。
