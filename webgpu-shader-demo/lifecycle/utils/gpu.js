...
export async function initWebGPU(canvas) {
  ...
  return {
    ...
    get depthView() { return depthView; },
    get depthRecreateCount() { return depthRecreateCount; },
    recreateDepth,
  };
}

/** @returns {{ vertices: Float32Array, indices: Uint16Array }} pos3 */
