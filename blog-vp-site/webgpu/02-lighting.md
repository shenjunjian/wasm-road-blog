...
配套 Demo：[`webgpu-shader-demo/lighting/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/webgpu-shader-demo/lighting/)（八面体，`1`/`2`/`3` 分步叠加 ambient / diffuse / specular）。
...
Demo WGSL（[`lighting/shaders/main.wgsl`](https://github.com/shenjunjian/wasm-road-blog/blob/main/webgpu-shader-demo/lighting/shaders/main.wgsl)）用 `params.x` 控制模式：
