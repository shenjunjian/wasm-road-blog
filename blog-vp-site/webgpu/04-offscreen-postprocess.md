...
配套 Demo：[`webgpu-shader-demo/postprocess/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/webgpu-shader-demo/postprocess/)（`B` 切换 Bloom）。
...
Demo 结构（[`postprocess/main.js`](https://github.com/shenjunjian/wasm-road-blog/blob/main/webgpu-shader-demo/postprocess/main.js)）：
