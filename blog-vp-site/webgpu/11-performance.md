...
配套 Demo：[`webgpu-shader-demo/performance/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/webgpu-shader-demo/performance/)（`M` 切换 500 draw vs 1 instanced draw）。
