...
[`compute/` 基础 demo](https://github.com/shenjunjian/wasm-road-blog/tree/main/webgpu-shader-demo/compute/) 用 Compute Shader 做数组求和并读回验证。本文进阶：**网格上的并行模拟**、**ping-pong storage**、以及 Compute 结果供 Render Pass 显示。

配套 Demo：[`webgpu-shader-demo/compute-advanced/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/webgpu-shader-demo/compute-advanced/) — Conway 生命游戏 128×128。
