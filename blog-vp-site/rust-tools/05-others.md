...
底层通过 `@rspack/binding` N-API 模块暴露 Rust 引擎；参见 [`napi-rs-demo/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/napi-rs-demo/)。
...
- 系列索引：[Rust 前端工具链系列](./)
- 可运行 demo：[`rust-tools-demo/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/rust-tools-demo/)
...
- 仓库 demo：[napi-rs-demo](https://github.com/shenjunjian/wasm-road-blog/tree/main/napi-rs-demo/) · [wasm-road-demo](https://github.com/shenjunjian/wasm-road-blog/tree/main/wasm-road-demo/)
