...
本系列中，Utoo 的独特价值在于 **`@utoo/web`**：在浏览器中通过 WASM + OPFS 跑完整工具链，与本仓库 [`wasm-road-demo/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/wasm-road-demo/) 的 Wasm 主题高度契合。
...
底层通过 `pack-napi` 与 Rust 侧 `pack-api` 通信，原理同 [`napi-rs-demo/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/napi-rs-demo/) 中的 N-API 绑定模式。
...
`@utoo/web` 完整浏览器环境配置较复杂，见官方文档；本地打包 demo 见 [`rust-tools-demo/utoo-pack`](https://github.com/shenjunjian/wasm-road-blog/tree/main/rust-tools-demo/utoo-pack/)。
...
依赖 `wasm-bindgen`、`wasm_thread`、`tracing-web`、`console_error_panic_hook` 等浏览器适配 crate。这与 [`wasm-road-demo/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/wasm-road-demo/) 中 wasm-pack 编译路径类似，但 Utoo 额外移植了完整 tokio + Turbopack 引擎，复杂度远高于单函数 Wasm 模块。
...
| N-API | ✅ `@utoo/pack` | 本地/CI bundler，参见 [`napi-rs-demo/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/napi-rs-demo/) |
| WASM | ✅ `@utoo/web` | 浏览器完整 dev/build，参见 [`wasm-road-demo/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/wasm-road-demo/) |
...
- 可运行 demo：[`rust-tools-demo/utoo-pack`](https://github.com/shenjunjian/wasm-road-blog/tree/main/rust-tools-demo/utoo-pack/)
- N-API 原理：[napi-rs-demo](https://github.com/shenjunjian/wasm-road-blog/tree/main/napi-rs-demo/) · Wasm 加载：[wasm-road-demo](https://github.com/shenjunjian/wasm-road-blog/tree/main/wasm-road-demo/)
