...
**重点章（01~04）** 配套 [`rust-tools-demo/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/rust-tools-demo/) 可运行 demo；粗讲章（05）仅博客 inline 代码。
...
仓库已有 [`napi-rs-demo/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/napi-rs-demo/)（N-API 绑定）、[`wasm-road-demo/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/wasm-road-demo/)（浏览器 Wasm）和 [`rust-tools-demo/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/rust-tools-demo/)（重点章可运行示例），各章在「集成模式」小节作概念交叉引用。
...
重点章（01~04）源码在 [`rust-tools-demo/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/rust-tools-demo/)：

| 博文 | Demo 目录 | 运行 |
| --- | --- | --- |
| 01 Oxc | [`oxc/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/rust-tools-demo/oxc/) | `cargo run` |
| 02 SWC | [`swc/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/rust-tools-demo/swc/) | `cargo run` |
| 03 Utoo | [`utoo-pack/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/rust-tools-demo/utoo-pack/) | `npm install && npm run dev` |
| 04 Vize | [`vize/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/rust-tools-demo/vize/) | `npm install && npm run dev` |
...
| 模式 | 代表 | 适用场景 | 仓库参考 |
| --- | --- | --- | --- |
| 纯 Rust crate | Oxc、`oxc_resolver` | CLI、代码生成、静态分析、自定义编译器 | [`rust-tools-demo/oxc`](https://github.com/shenjunjian/wasm-road-blog/tree/main/rust-tools-demo/oxc/) |
| N-API 绑定 | `@swc/core`、`@utoo/pack`、`@vizejs/native` | Node 构建工具、Webpack/Rspack 插件 | [`rust-tools-demo/utoo-pack`](https://github.com/shenjunjian/wasm-road-blog/tree/main/rust-tools-demo/utoo-pack/)、[`vize`](https://github.com/shenjunjian/wasm-road-blog/tree/main/rust-tools-demo/vize/)；[`napi-rs-demo/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/napi-rs-demo/) |
| WASM 绑定 | `@utoo/web`、`@vizejs/wasm` | 浏览器内编译、无后端预览 | [`wasm-road-demo/`](https://github.com/shenjunjian/wasm-road-blog/tree/main/wasm-road-demo/) |
